...
# import streamlit as st
# from pdf_chatbot import PDFChatbot
# from utils import save_uploaded_file  # removed load_api_key
...
#         "role": "assistant",
#         "content": "Hello! I am ready to answer your questions about the uploaded PDF. Please upload one to begin."
#     })
...
import streamlit as st
from pdf_chatbot import PDFChatbot
from utils import save_uploaded_file  # no load_api_key needed
...
if uploaded_file:
    with st.spinner("Processing PDF..."):
        try:
            # ✅ No need to pass API key manually anymore
            chatbot = PDFChatbot()
            temp_file_path = save_uploaded_file(uploaded_file)
            raw_text = chatbot.extract_text(temp_file_path)
            chunks = chatbot.split_text(raw_text)
